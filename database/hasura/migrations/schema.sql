...
CREATE SEQUENCE public.citation_upvotes_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
ALTER SEQUENCE public.citation_upvotes_id_seq OWNED BY public.citation_upvotes.id;
...
ALTER TABLE ONLY public.citation_upvotes
    ADD CONSTRAINT citation_upvotes_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.citation_upvotes
    ADD CONSTRAINT "citation_upvotes_userId_citationId_key" UNIQUE ("userId", "citationId");
...
ALTER TABLE ONLY public.citation_upvotes
    ADD CONSTRAINT "citation_upvotes_citationId_fkey" FOREIGN KEY ("citationId") REFERENCES public.citations(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.citations
...
LIMIT 1
$$;
CREATE FUNCTION public.get_random_citation(collectionid uuid) RETURNS SETOF public.citations
    LANGUAGE sql STABLE
    AS $$
